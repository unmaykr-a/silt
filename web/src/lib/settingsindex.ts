...
export const SETTINGS: SettingEntry[] = [
  ...
  { name: "local_account", section: "identity", label: "Built-in account", env: "SILT_LOCAL_ACCOUNT", keywords: "password login single admin" },
  ...
  { name: "oidc_issuer", section: "identity", label: "Issuer", env: "SILT_OIDC_ISSUER", keywords: "oidc sso provider keycloak authentik openid connect" },
  { name: "oidc_client_id", section: "identity", label: "Client ID", env: "SILT_OIDC_CLIENT_ID", keywords: "oidc registered client" },
  { name: "oidc_client_secret", section: "identity", label: "Client secret", env: "SILT_OIDC_CLIENT_SECRET", keywords: "oidc secret credential" },
  { name: "oidc_redirect_url", section: "identity", label: "Redirect URL", env: "SILT_OIDC_REDIRECT_URL", keywords: "callback oidc register" },
  { name: "oidc_scopes", section: "identity", label: "Scopes", env: "SILT_OIDC_SCOPES", keywords: "openid profile email oidc" },
  { name: "oidc_username_claim", section: "identity", label: "Username claim", env: "SILT_OIDC_USERNAME_CLAIM", keywords: "preferred_username email sub oidc" },
  { name: "oidc_groups_claim", section: "identity", label: "Groups claim", env: "SILT_OIDC_GROUPS_CLAIM", keywords: "groups roles oidc" },
  { name: "oidc_allowed_groups", section: "identity", label: "Allowed groups", env: "SILT_OIDC_ALLOWED_GROUPS", keywords: "allowlist restrict who may sign in oidc" },
  { name: "oidc_allowed_users", section: "identity", label: "Allowed users", env: "SILT_OIDC_ALLOWED_USERS", keywords: "allowlist restrict who may sign in oidc" },
  ...
  { name: "session_ttl_ms", section: "identity", label: "Session lifetime", env: "SILT_SESSION_TTL", keywords: "how long signed in expiry" },
  { name: "session_idle_ttl_ms", section: "identity", label: "Idle timeout", env: "SILT_SESSION_IDLE_TTL", keywords: "unused session expiry" },
  { name: "oidc_admin_ttl_ms", section: "identity", label: "Administrator rights expire after", env: "SILT_OIDC_ADMIN_TTL", keywords: "admin lapse stale demote revoke role expiry groups refresh sign in again" },
